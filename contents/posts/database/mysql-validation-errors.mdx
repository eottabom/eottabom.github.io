...
date: "2020-05-17"
tags: ["Database"]
summary: "MySQL Validation errors Cause and Workaround"
description: "MySQL Validation errors 원인과 해결 방법"
---

:::info
흔하지 않은 경우이지만, 데이터를 조회할 때 <b>JAVA – Value '0000-00-00' can not be represented as java.sql.Date</b> 를 만나게 되었고,
