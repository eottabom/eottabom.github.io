...
:::info
<a href = "https://openjdk.org/projects/amber/guides/lvti-style-guide">Local Variable Type Inference Style Guidelines</a> 에 대한 내용 정리
Java SE 10 에는 <a href = "https://openjdk.org/jeps/286"> 지역 변수에 대한 유형 추론 </a>이 도입되었다.
